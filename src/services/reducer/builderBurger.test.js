...
describe('burgerConstructorReducer', () => {
    ...
    it('должен добавлять ингредиент', () => {
        const action = { type: ADD_BUILDER_BURGER_INGREDIENT, ingredient: { _id:"643d69a5c3f7b9001cfa0943",
        ...
        expect(newState.ingredientsBurger).toContainEqual(action.ingredient);
    });

    it('должен заменять булочку', () => {
        const stateWithBurger = {
            ...initialState,
            ingredientsBurger: [{_id:"643d69a5c3f7b9001cfa0943",
                name:"Соус фирменный Space Sauce",
                type:"sauce",
                proteins:50,
                fat:22,
            ...
            bun:{_id:"643d69a5c3f7b9001cfa093d",
        ...
        const action = { type: REPLACE_BUN, bun: { _id:"643d69a5c3f7b9001cfa093c",
        ...
        expect(newState.bun).toEqual({_id:"643d69a5c3f7b9001cfa093c",
            name:"Краторная булка N-200i",
            type:"bun",
            proteins:80,
            fat:24,
    ...
    it('должен перемещать ингредиент', () => {
        ...
        expect(newState.ingredientsBurger[0]).toEqual({ _id:"643d69a5c3f7b9001cfa0945",
            name:"Соус с шипами Антарианского плоскоходца",
            type:"sauce",
            proteins:101,
            fat:99,
            ...
            __v:0,
            uniqueId:"d0215f28-8360-4cf3-9e81-7b26f1a73bbb" });
        expect(newState.ingredientsBurger[1]).toEqual({ _id:"643d69a5c3f7b9001cfa0943",
            name:"Соус фирменный Space Sauce",
            type:"sauce",
            proteins:50,
            fat:22,
